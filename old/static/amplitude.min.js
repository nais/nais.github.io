var amplitude = (function () {
		...
		c = function (e) {
			for (var t, i, n = "", o = 0, r = 0; o < e.length; )
				(t = e.charCodeAt(o)) < 128
					...
					: ((r = e.charCodeAt(o + 1)),
					  (i = e.charCodeAt(o + 2)),
					  (n += String.fromCharCode(((15 & t) << 12) | ((63 & r) << 6) | (63 & i))),
					  (o += 3));
			return n;
		},
		h =
			...
			_decode: function (e) {
				...
				for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); u < e.length; )
					(t =
						...
						(i = ((15 & o) << 4) | ((r = f._keyStr.indexOf(e.charAt(u++))) >> 2)),
	...
	function a(e, t, i) {
		return (
			_(e) === i ||
			(T.error("Invalid " + t + " input type. Expected " + i + " but received " + _(e)), !1)
		);
	}
	function u(e) {
		var t = _(e);
		...
		if (Object.keys(e).length > w.MAX_PROPERTY_KEYS)
			return T.error("Error: too many properties (more than 1000), ignoring"), {};
		var i,
			n,
			o,
			r = {};
	...
	function m(e) {
		...
		return (
			n && (t = parseInt(n, 32)), t || (P.warn("unable to parse malformed cookie: ".concat(i)), 0)
		);
	}
	function E(e) {
		if (e) {
	...
	var e,
		...
		R = function e(t, i) {
			var n = _(i);
			if (-1 !== C.indexOf(n))
				T.warn('WARNING: Property key "' + t + '" with invalid value type ' + n + ", ignoring"),
					(i = null);
			else if ("undefined" === n) i = null;
			else if ("error" === n)
				(i = String(i)),
					T.warn('WARNING: Property key "' + t + '" with value type error, coercing to ' + i);
			else if ("array" === n) {
				for (var o = [], r = 0; r < i.length; r++) {
					...
					"array" !== a
						? "object" === a
							? o.push(u(s))
							: o.push(e(t, s))
						: T.warn("WARNING: Cannot have " + a + " nested in an array property value, skipping");
				}
				i = o;
			} else "object" === n && (i = u(i));
			return i;
					...
					"array" !== s && "object" !== s
						? "string" === s
							...
							: ("date" !== s && "number" !== s && "boolean" !== s) ||
							  ...
							  n.push(r))
						: T.warn("WARNING: Skipping nested " + s + " in array groupName");
				}
				return n;
			}
			T.warn(
		...
		z = function (e) {
			return (
				...
				(!(0 <= e.indexOf(".")) ||
					(T.error(
						"Device IDs may not contain '.' characters. Value will be ignored: \"".concat(e, '"'),
					),
					!1))
			);
		},
			...
			return (
				...
				(e !== w.TRANSPORT_HTTP && e !== w.TRANSPORT_BEACON
					...
					: !(e !== w.TRANSPORT_HTTP && !navigator.sendBeacon) ||
					  (T.error("browser does not support sendBeacon, so transport must be HTTP"), !1))
			);
		},
		B = function (e) {
			return (
				!!(a(e, "sessionId", "number") && 0 < new Date(e).getTime()) ||
				(T.error("sessionId value must in milliseconds since epoch (Unix Timestamp)"), !1)
			);
		},
		X = function () {
			return h.location;
		...
		Y = { expirationDays: void 0, domain: void 0 },
		H = function (e) {
			var t = I(e) + "=",
				i = W.get(t);
			try {
		...
		Q = {
			...
			options: function (e) {
				...
				(e = e || {}),
					(Y.expirationDays = e.expirationDays),
					(Y.secure = e.secure),
					(Y.sameSite = e.sameSite);
			...
			? ((S = document.createElement("div")),
			  ...
			  S.addBehavior &&
					...
					(e = {
						...
						clear: function () {
							S.load(N);
							for (var e, t = 0; (e = S.XMLDocument.documentElement.attributes[t++]); )
								...
								return 0 === arguments.length
									...
									: ((e = e || {}),
									  ...
									  (this._options.domain =
											e.domain || this._options.domain || (h && h.location && h.location.hostname)),
					...
					},
					{
						...
						value: function () {
							...
							if (
								...
								try {
									(e = h.sessionStorage && h.sessionStorage.getItem(this.storageKey)),
	...
	(re.prototype.add = function (e, t) {
		return (
			"number" === _(t) || "string" === _(t)
				...
				: P.error("Unsupported type for value: " + _(t) + ", expecting number or string"),
			this
		);
	}),
		...
		(re.prototype._addOperation = function (e, t, i) {
			Object.prototype.hasOwnProperty.call(this.userPropertiesOperations, ue)
				? P.error("This identify already contains a $clearAll operation, skipping operation " + e)
				...
				: P.error(
						'User property "' + t + '" already used in this identify, skipping operation ' + e,
				  );
		});
	var ce =
		"undefined" != typeof globalThis
	...
	var pe = le(function (e) {
			...
			function u(e, t) {
				...
				for (
					var s = 1732584193, a = -271733879, u = -1732584194, c = 271733878, l = 0;
					l < e.length;
					l += 16
				)
					(s = d((i = s), (n = a), (o = u), (r = c), e[l], 7, -680876936)),
						...
						(s = f(s, (a = h(a, u, c, s, e[l + 12], 20, -1926607734)), u, c, e[l + 5], 4, -378558)),
						...
						(s = v(s, (a = f(a, u, c, s, e[l + 2], 23, -995338651)), u, c, e[l], 6, -198630844)),
			...
			function r(e, t) {
				return (function (e, t) {
					var i,
						...
						s = [];
					for (
						r[15] = s[15] = void 0, 16 < o.length && (o = u(o, 8 * e.length)), i = 0;
						i < 16;
						i += 1
					)
	...
	ye.prototype.send = function (t) {
		...
		!!h.XDomainRequest
			...
			? ((i = new XMLHttpRequest()).open("POST", this.url, !0),
			  ...
			  (function (e, t) {
					for (var i in t)
						("Cross-Origin-Resource-Policy" === i && !t[i]) || e.setRequestHeader(i, t[i]);
			  })(i, this.headers),
			  i.send(we(this.data)))
			: ((n = void 0),
			  fetch(this.url, { method: "POST", headers: this.headers, body: we(this.data) })
					.then(function (e) {
	...
	(_e.prototype.setProductId = function (e) {
		return (
			"string" !== _(e)
				? P.error("Unsupported type for productId: " + _(e) + ", expecting string")
				: q(e)
		...
		(_e.prototype.setQuantity = function (e) {
			return (
				"number" !== _(e)
					? P.error("Unsupported type for quantity: " + _(e) + ", expecting number")
		...
		(_e.prototype.setPrice = function (e) {
			return (
				"number" !== _(e)
					? P.error("Unsupported type for price: " + _(e) + ", expecting number")
					: (this._price = e),
				this
			);
		}),
		(_e.prototype.setRevenueType = function (e) {
			return (
				"string" !== _(e)
					? P.error("Unsupported type for revenueType: " + _(e) + ", expecting string")
					: (this._revenueType = e),
				this
			);
		}),
		(_e.prototype.setEventProperties = function (e) {
			return (
				"object" !== _(e)
					? P.error("Unsupported type for eventProperties: " + _(e) + ", expecting object")
		...
		(_e.prototype._isValidRevenue = function () {
			return (
				"number" === _(this._price) || (P.error("Invalid revenue, need to set price field"), !1)
			);
		}),
		(_e.prototype._toJSONObject = function () {
			...
			return (
				...
				null !== this._revenueType && (e[w.REVENUE_REVENUE_TYPE] = this._revenueType),
				e
			);
		});
	function Ee(e) {
	...
	function Ie(e) {
		d() ||
			...
			(this.options = y({}, Te, { trackingOptions: y({}, Te.trackingOptions) })),
	...
	var Se = le(function (z, K) {
			!(function (o, p) {
				...
				function s(e, t) {
					if (typeof e == c)
						return (
							...
							typeof t == u ? e : e.substring(0, 275)
						);
				}
				function a(e, t) {
									...
									(s = r[++i]),
										typeof (o = c[n]) == h && 0 < o.length
											? 2 === o.length
												...
												: 4 === o.length &&
												  (this[o[0]] = s ? o[3].call(this, s.replace(o[1], o[2])) : p)
											: (this[o] = s || p);
						a += 2;
					}
				}
				function t(e, t) {
					for (var i in t)
						if (typeof t[i] == h && 0 < t[i].length) {
							for (var n = 0; n < t[i].length; n++) if (r(t[i][n], e)) return "?" === i ? p : i;
						...
						return (
							(this.getBrowser = function () {
								...
								return (
									...
									(t.major =
										typeof (e = t.version) == c ? e.replace(/[^\d\.]/g, "").split(".")[0] : p),
									t
								);
							}),
				...
				(G.VERSION = "0.7.31"),
					...
					(G.ENGINE = G.OS = e([f, g])),
					z.exports && (K = z.exports = G),
					(K.UAParser = G);
				var L,
					F = typeof o != u && (o.jQuery || o.Zepto);
				F &&
					!F.ua &&
					((L = new G()),
					(F.ua = L.getResult()),
		...
		Te = {
			...
			includeUtm: !1,
			language: Ne(),
			library: { name: "amplitude-js", version: "8.18.4" },
			logLevel: "WARN",
		...
		xe = new ((function () {
			function e() {
				return (
					p(this, e),
					e.instance || ((this.ingestionEndpoint = w.EVENT_LOG_URL), (e.instance = this)),
					e.instance
				);
			}
			return (
			...
			!(function (e) {
				...
				var o = i(function (ie, ne) {
						(function (o, p) {
							...
							var Q = function (e, t) {
								...
								var i =
									e ||
									(typeof o !== a && o.navigator && o.navigator.userAgent
										? o.navigator.userAgent
										: r);
								var n = t ? F(J, t) : J;
								this.getBrowser = function () {
					...
					s = function (e) {
						var t, i;
						return [
							(t = e.browser) === null || t === void 0 ? void 0 : t.name,
							(i = e.browser) === null || i === void 0 ? void 0 : i.major,
						]
							.filter(function (e) {
				...
				var p = (function () {
						...
						e.prototype.editIdentity = function () {
							...
							var f = l(l({}, this.identity), { userProperties: t });
							return {
				...
				(e.AnalyticsConnector = h), Object.defineProperty(e, "__esModule", { value: true });
			})(t);
		});
	(Ie.prototype.Identify = re),
		...
		(Ie.prototype.init = function (e, o, r, t) {
			...
			if ("string" !== _(e) || q(e))
				...
				try {
					(this._connector = Ae.AnalyticsConnector.getInstance(this._instanceName)),
						Re(this.options, r),
						(d() || j()) &&
							void 0 !== h.Prototype &&
						...
						this.options.cookieName !== Te.cookieName &&
							P.warn(
						...
						(this._storageSuffix =
							"_" +
							e +
							(this._instanceName === w.DEFAULT_INSTANCE ? "" : "_" + this._instanceName)),
					...
					this.options.saveEvents &&
						...
						(function (e) {
							r &&
								...
								delete r.deviceId),
								(s.options.deviceId = s._getInitialDeviceId(r && r.deviceId, e)),
								(s.options.userId =
									("string" === _(o) && !q(o) && o) ||
							...
							i &&
								...
								s.options.saveParamsReferrerOncePerSession || s._trackParamsAndReferrer(),
								s.options.saveEvents && (Ce(s._unsentEvents), Ce(s._unsentIdentifys)),
								(s._lastEventTime = t),
								qe(s),
							...
							("transport" === n && !K(o)) ||
								("sessionId" !== n || null === o
									? L(o, n + " option", r) &&
									  ("boolean" === r
											? (t[n] = !!o)
											: ("string" === r && !q(o)) || ("number" === r && 0 < o) || "function" === r
											? (t[n] = o)
											: "object" === r && e(t[n], o))
									: (t[n] = B(o) ? o : null))));
		}
	...
	(Ie.prototype.runQueuedFunctions = function () {
		...
		(Ie.prototype._apiKeySet = function (e) {
			return (
				...
				(P.error("Invalid apiKey. Please set a valid apiKey with init() before calling " + e), !1)
			);
		}),
	...
	var Ue = function (e) {
			var t, i;
			e._useOldCookie
				? "object" !== _((t = e.cookieStorage.get(e._oldCookiename))) || Pe(e, t)
	...
	(Ie.prototype.identify = function (e, t, i, n) {
		...
		if (this._apiKeySet("identify()"))
			if (
				...
				ze(t, i, 0, "No request sent", { reason: "No user property operations" });
			} else
				P.error("Invalid identify input type. Expected Identify object but saw " + _(e)),
					ze(t, i, 0, "No request sent", { reason: "Invalid identify input type" });
				...
				if (L(e, "group_type", "string") && !q(e))
					if (null != t)
						if (
							...
							ze(n, o, 0, "No request sent", { reason: "No group property operations" });
						} else
							P.error("Invalid identify input type. Expected Identify object but saw " + _(i)),
								ze(n, o, 0, "No request sent", { reason: "Invalid identify input type" });
				...
				if (this.options.optOut)
					...
					try {
						...
						return (
							...
							e === w.IDENTIFY_EVENT || e === w.GROUP_IDENTIFY_EVENT
								? (this._unsentIdentifys.push({ event: m, callback: a, errorCallback: u }),
								  this._limitEventsQueued(this._unsentIdentifys))
								: (this._unsentEvents.push({ event: m, callback: a, errorCallback: u }),
		...
		(Ie.prototype.logEventWithTimestamp = function (e, t, i, n, o, r) {
			...
			return this._shouldDeferCall()
				...
				? L(e, "eventType", "string")
					? q(e)
						? (ze(n, o, 0, "No request sent", { reason: "Missing eventType" }), -1)
						: (L(s, "outOfSession", "boolean") ||
								ze(n, o, 0, "No request sent", { reason: "Invalid outOfSession value" }),
						  this._logEvent(e, t, null, null, null, null, i, n, o, s))
					: (ze(n, o, 0, "No request sent", { reason: "Invalid type for eventType" }), -1)
	...
	(Ie.prototype.sendEvents = function () {
		if (this._apiKeySet("sendEvents()")) {
			if (this.options.optOut)
				...
				var e =
						(this.options.forceHttps || "https:" === h.location.protocol ? "https" : "http") +
						"://" +
							...
							try {
								200 === e && "success" === t
									...
									: (u._logErrorsOnEvents(n, o, e, t),
									  413 === e &&
											(1 === u.options.uploadBatchSize && u.removeEvents(n, o, e, t),
		...
		(Ie.prototype.setEventUploadThreshold = function (e) {
			if (L(e, "eventUploadThreshold", "number")) {
				if (this._shouldDeferCall())
					return this._q.push(
						["setEventUploadThreshold"].concat(Array.prototype.slice.call(arguments, 0)),
					);
				try {
